...
$(document).ready(function () {
    ...
    $('#contact_form').submit(function () {
        ...
        if ($(this).valid()) {
            ...
            var company = $form.find("#company_name").val() || "";
            var campaign = $form.find("#campaign").val() || "";
            var phone = $form.find("#contact_phone").val() || "";
            var message = $form.find("#contact_message").val() || "";
            ...
            jQuery.ajax({
                ...
                type: "GET",
                data: {
                    "insert": "{\"SHEET_NAME\":\"Sheet1\",\"DATA\":[{\"email\":\"" + email + "\",\"name\":\"" + name + "\",\"phone\":\"" + phone + "\",\"company\":\"" + company + "\",\"message\":\"" + message + "\",\"campaign\":\"" + campaign + "\",\"date\":\"" + $.now() + "\"}]}"
                }
            })
